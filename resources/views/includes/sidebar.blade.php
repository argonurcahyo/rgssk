<div class="sidebar-wrapper active">
    <div class="sidebar-header position-relative">
        <div class="d-flex justify-content-between align-items-center">
            <div class="logo">
                <a href="index.html">
                    <img src="{{ asset('images/logo/logo.svg') }}" alt="Logo" srcset="" />
                </a>
            </div>
    ...
    <div class="sidebar-menu">
        <ul class="menu">
            ...
            <li class="sidebar-item {{ Request::is('form/layout') ? 'active' : '' }}">
            ...
            <li class="sidebar-item has-sub {{ Request::is('datatable*') ? 'active' : '' }}">
                <a href="#" class="sidebar-link">
                ...
                <ul class="submenu">
                    <li class="submenu-item">
                        <a href="{{ url('/datatable/1') }}">Datatable</a>
                    </li>
                    <li class="submenu-item">
                        <a href="{{ url('/datatable/2') }}">Datatable (jQuery)</a>
                    </li>
                </ul>
            </li>
